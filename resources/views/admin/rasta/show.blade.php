        ...
        <div class="card-body row">
            <div class="col-12">
                ...
                <div class="form-group">
                    ...
                    <img src="/admin/images/rasta/{{$item->image}}" class="form-text" width="400px">
                </div>
                <hr>
                <div class="form-group">
                ...
                <div class="form-group">
                    <a href="{{ route('admin.rasta.index') }}" class="btn btn-primary">Orqaga qaytish</a>
                </div>
            </div>
        </div>
    </div>
