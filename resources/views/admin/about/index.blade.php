                    ...
                    <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
                       ...
                       <tbody>
                          ...
                          <tr class="odd">
                             ...
                             <td class=""><img src="/admin/images/about/{{$item->image}}" width="100%" alt="" srcset=""></td>
                             <td class="project-actions text-center dtr-control" >
                                <a class="btn btn-primary btn-sm col-md-10" href="{{route('admin.about.show', $item->id)}}" style="margin-bottom: 10px">
                                    <i class="fas fa-folder" >
                                    </i>
                                    Barchasi
                                </a> <br>
                                <a class="btn btn-info btn-sm col-md-10" href="{{route('admin.about.edit', $item->id)}}" style="margin-bottom: 10px">
