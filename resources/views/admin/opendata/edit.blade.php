...
<section class="content-header">
       ...
       <div class="row mb-2">
          ...
          <div class="col-sm-6">
             <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item "> <a href="{{ route('admin.opendata.index') }}">Ochiq ma'lumotlar</a> </li>
    ...
    <div class="col-md-9">
        ...
        <div class="card card-primary">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{route('admin.opendata.update', $item->id)}}" method="post" enctype="multipart/form-data">
            @method('patch')
            @csrf
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Batafsil ma'lumotlarni yozing" value="{{ $item->body }}" name="body" >
              </div>
